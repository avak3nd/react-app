...
function NewReleases() {
    document.title = "React Games | Top New Releases";

    const { data: games = [], isLoading, isError } = useGamesByTag("new_release");
    ...
    return (
        <div className="max-w-300 mx-auto text-white py-8">
            <b className="text-[35px] max-[768px]:text-[30px] max-[500px]:text-[25px] max-[400px]:text-[20px]">Top New Releases</b>
